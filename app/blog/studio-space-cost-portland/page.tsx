    ...
    <main style={{ background: '#f4f1eb', color: '#1a1814' }} className="min-h-screen">
      <div className="mx-auto max-w-2xl px-6 py-14">
        ...
        <div style={{ borderTop: '1px solid #d6d0c4' }} className="space-y-10 pt-10">
          ...
          <section>
            ...
            <p style={{ color: '#6b6762' }} className="mb-3 text-sm leading-relaxed">
              <strong style={{ color: '#1a1814' }}>Typical range: $200–$800/month</strong>
            </p>
          ...
          <section>
            ...
            <p style={{ color: '#6b6762' }} className="mb-3 text-sm leading-relaxed">
              <strong style={{ color: '#1a1814' }}>Typical range: $400–$2,000/month</strong>
            </p>
            <p style={{ color: '#6b6762' }} className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <p style={{ color: '#6b6762' }} className="mb-3 text-sm leading-relaxed">
              <strong style={{ color: '#1a1814' }}>Typical range: $600–$2,500/month</strong>
            </p>
            <p style={{ color: '#6b6762' }} className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <p style={{ color: '#6b6762' }} className="mb-3 text-sm leading-relaxed">
              <strong style={{ color: '#1a1814' }}>Typical range: $500–$2,000/month</strong>
            </p>
            <p style={{ color: '#6b6762' }} className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <p style={{ color: '#6b6762' }} className="mb-3 text-sm leading-relaxed">
              <strong style={{ color: '#1a1814' }}>Typical range: $250–$700/month</strong>
            </p>
            <p style={{ color: '#6b6762' }} className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul style={{ color: '#6b6762' }} className="mt-3 space-y-2 text-sm">
              <li><strong style={{ color: '#1a1814' }}>Neighborhood.</strong> Pearl District and NW Portland are the most expensive. Central Eastside, NE, and N Portland offer good value. SE Portland is middle ground.</li>
              <li><strong style={{ color: '#1a1814' }}>Infrastructure.</strong> 220v power, roll-up door, ventilation system, sprung floor, cyclorama wall — specialized features add to the base rate.</li>
              <li><strong style={{ color: '#1a1814' }}>What&apos;s included.</strong> Utilities, internet, parking, equipment, and materials storage all affect the real cost. A higher-priced listing that includes utilities and parking may be cheaper than a lower-priced one with add-ons.</li>
              <li><strong style={{ color: '#1a1814' }}>Term flexibility.</strong> Month-to-month costs more than a 6-month or annual commitment. If you know you&apos;ll stay, ask about a longer-term rate.</li>
              <li><strong style={{ color: '#1a1814' }}>Size.</strong> Square footage is not always listed, but it&apos;s worth asking. A larger space at a lower per-square-foot rate may be better value than a smaller space at the top of its range.</li>
            </ul>
          </section>
        ...
        <div style={{ borderTop: '1px solid #d6d0c4' }} className="mt-12 pt-10">
          <p style={{ color: '#6b6762', fontFamily: 'var(--font-mono)' }} className="mb-4 text-xs uppercase tracking-wider">Browse by type</p>
