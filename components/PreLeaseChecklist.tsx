...
// build-out research. Converts before signing. The deal-breaker list is the
// SEO and conversion differentiator: no other Portland studio directory
...
function getChecklist(studioType: string): Item[] | null {
